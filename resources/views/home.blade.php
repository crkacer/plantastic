        ...
        <v-layout row>
          ...
          <v-flex sm12 class="ml-5">
            ...
            <v-layout column wrap>
              ...
              <v-flex xs12 v-for="(event,i) in events" :key="i" class="mb-4">
                <v-card raised>
                    ...
                    <v-layout column>
                      <v-flex xs12>
                        <v-layout class="ma-0 pa-0" row>
                          <v-flex xs4>
                            <a :href=event.url>
                            <v-card-media :src= event.src height="150px" contain></v-card-media>
                            </a>
                          </v-flex>
                          <v-flex xs7>
                              <div class="text-xs-left ma-0 pa-2" style="font-family: 'Lora', serif;">@{{ event.date }}</div>
                              <div class="headline text-xs-left pl-2" style="font-family: 'Cinzel', serif;"><b>@{{ event.title }}</b></div>
                              <div class="text-xs-left ma-0 pa-2" style="font-family: 'Lora', serif;">@{{ event.locationName }}</div>
                          </v-flex>
                          <v-flex xs6>
